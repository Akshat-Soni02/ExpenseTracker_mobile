...
//below is improved code not including paid by
...
//below is new code with included paid by
...
//   const toggleUserSelection = (user: { _id: string; name: string, profile_photo?: string }) => {
//     let newSelectedUsers;
