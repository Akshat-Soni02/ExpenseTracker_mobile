...
//     const friends = contacts.filter((contact) => selectedContacts.has(contact.recordID));
...
//           backgroundColor: isSelected ? "#cfe2ff" : "white", // Optimized color change
//         }}
//       >
//         <View style={{ flex: 1 }}>
...
//         extraData={selectedContacts} // Prevents unnecessary re-renders
//       />
...
//             Add {selectedContacts.size} Friend(s)
//           </Text>
//         </TouchableOpacity>
//       )}
//     </View>
...
const ContactsScreen = () => {
  ...
  const navigateToEmailInput = () => {
    ...
    router.push({ pathname: "addPeopleEmail", params: { contacts: JSON.stringify(selected) } });
  };
