        ...
        <ScrollView style={styles.container}>   
          ...
          {numberOfPeople>0?(<FlatList
              ...
              renderItem={({ item }) => (
                ...
                amount={`₹${item.amount}`}
                subtitle={undefined}
                optionText={item.exchange_status === "lended" ? "You lend" : item.type === "borrowed" ? "You owe" : "settled"}
                transactionType={item.exchange_status === "lended" ? "expense" : item.type === "borrowed" ? "income" : undefined}
                />
