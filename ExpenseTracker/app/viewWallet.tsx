  ...
  return (
    <View style={[styles.container]}>
      <View style={styles.header}>
        ...
        >
          <Menu.Item onPress={() => router.push({pathname:"/editWallet",params:{fetchedId:id,fetchedAmount:wallet.amount,fetchedName:wallet.wallet_title,fetchedLowerLimit:wallet.lower_limit}})} title="Edit" />
          <Divider />
