      ...
      <View style={styles.summaryContainer}>
        {amountNumber >= 0 ? (
          <Text style={styles.summaryText}>
            You lend <Text style={styles.greenAmount}>₹{amountNumber}</Text> to {data.data.name}
          </Text>
        ) : (
          <Text style={styles.summaryText}>
            You owe <Text style={styles.redAmount}>₹{Math.abs(amountNumber)}</Text> to {data.data.name}
          </Text>
        )}
      </View>
    </View>
