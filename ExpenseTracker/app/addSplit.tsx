...
//     router.push("../addSplitPeople");
//   };
//     const [open, setOpen] = useState(false);
//     const [selectedUsers, setSelectedUsers] = useState<{ label: string; value: string;amount:string }[]>([]);
...
//           const exists = prev.find((u) => u.value === name);
//           return exists
//             ? prev.filter((u) => u.value !== name) // Remove if already selected
//             : [...prev, {label: name, value:name,amount: '' }]; // Add with empty amount
//         });
//       };
...
//             label="Add People"
//             style={styles.fab}
//             onPress={() => router.push("../addSplitPeople")}
//         />
//         {/* <DropDownPicker
//         open={open}
//         setOpen={setOpen}
